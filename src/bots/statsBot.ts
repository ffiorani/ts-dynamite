...
class Bot {
    ...
    public makeMove(gamestate: Gamestate): BotSelection {
        ...
        const runningAverage = this.computeRunningAverage(gamestate);
        const maxIndex = runningAverage.indexOf(Math.max(...runningAverage));
    ...
    private computeRunningAverage(gamestate): number[] {
